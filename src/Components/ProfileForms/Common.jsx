...
const languagesList = ["English", "Urdu", "Punjabi", "Sindhi", "Pashto", "Balochi", "Saraiki"]
...
const patientGroupsList = {
    "Personal Information": [
        { label: "Full Name", type: "text", placeholder: "Full Name", name: "fullName" },
        { label: "Date of Birth", type: "date", placeholder: "Date of Birth", name: "dateOfBirth" },
        { label: "Gender", options: gendersList, name: "gender", dropdown: true }
    ],
    "Contact Information": [
        { label: "Address", type: "text", placeholder: "Address", name: "address" },
        { label: "Phone Number", type: "tel", placeholder: "Phone Number", name: "phoneNumber" },
        { label: "Email Address", type: "email", placeholder: "Email Address", name: "emailAddress" },
    ...
    // ],
    "Emergency Contact": [
        { label: "Contact Name", type: "text", placeholder: "Contact Name", name: "emergencyContactName" },
        { label: "Contact Number", type: "tel", placeholder: "Contact Number", name: "emergencyContactNumber" }
    ],
...
const careTakerGroupsList = {
    "Personal Information": [
        ...
        { label: "Date of Birth", type: "date", placeholder: "Date of Birth", name: "dateOfBirth" },
        { label: "Gender", options: gendersList, name: "gender", dropdown: true },
        { label: "Biography", placeholder: "Enter Biography", name: "biography", textArea: true }
    ],
    "Contact Information": [
        { label: "Address", type: "text", placeholder: "Address", name: "address" },
        { label: "Phone Number", type: "tel", placeholder: "Phone Number", name: "phoneNumber" },
    ...
    "Professional Details": [
        ...
        { label: "Experience", type: "number", placeholder: "Experience", name: "experience" },
        { label: "Certifications", type: "text", placeholder: "Certifications", name: "certifications" },
        { label: "Certifications Files", name: "certificationFiles", files: true },
        { label: "Skills", type: "text", placeholder: "Skills", name: "skills" },
        { label: "Services", options: servicesList, name: "services", checkbox: true }
    ],
    // "Medical Information": [
    //     { label: "Medical History", type: "text", placeholder: "Medical History", name: "medicalHistory" },
    //     { label: "Allergies", type: "text", placeholder: "Allergies", name: "allergies" },
    ...
    "Work Schedule and Availability": [
        { label: "Start Time", type: "time", placeholder: "Start Time", name: "startTime" },
        { label: "End Time", type: "time", placeholder: "End Time", name: "endTime" },
        { label: "Days Available", options: weekdaysList, name: "daysAvailable", checkbox: true }
    ],
    "Preferred Languages": [
        { label: "Preferred Languages", options: languagesList, name: "preferredLanguages", checkbox: true }
    ],
...
const FormGroupItem = ({ label, type, placeholder, name, value, handleChange }) => {
    return (
        <Form.Group>
            ...
            <Row className="justify-content-center align-items-center">
                <Col onClick={handleImageClick}>
                    <Image
                        ...
                        alt="Image Alt Text"
                        fluid
                        style={{ maxHeight: '100px', maxWidth: '80%', borderRadius: '10px', cursor: 'pointer' }}
                    />
                </Col>
            </Row>
            <Form.Control name={name} id='cnicImgFile' type="file" accept='image/*' hidden onChange={handleImageChange} />
        </Form.Group>
    );
};
            ...
            <ListGroup as="ol">
                {
                    Object.keys(files).map((key) => (
                        <ListGroup.Item as="li"><b>{parseInt(key) + 1}. </b>{files[key].name}</ListGroup.Item>
                    ))
                }
            </ListGroup>
        </Form.Group>
...
const GroupsContainer = ({ label, children }) => {
    return (
        <Form.Group className="form-group-container mb-3">
            <Form.Group className='px-3 py-2' style={{ backgroundColor: "#ddd", borderRadius: "10px" }}>
...
const ItemsList = ({ itemList, formData, handleChange }) => {
    return (
        Object.keys(itemList).map((group, groupIndex) => (
            <GroupsContainer
                key={groupIndex}
                label={group}
...
const RoundImageForm = ({ image, onImageChange }) => {
    ...
    return (
        <Form.Group className="form-group-container text-center" >
            <div className="rounded-circle overflow-hidden mx-auto mb-3" style={{ width: '150px', height: '150px', cursor: 'pointer' }} onClick={handleImageClick}>
                <Image src={typeof image === 'string' ? image : URL.createObjectURL(image)} alt="Profile Image" className="w-100 h-100" roundedCircle />
            </div>
            <Form.Control id='imageUpload' type="file" accept='image/*' hidden onChange={handleFileChange} />
        </Form.Group>
    );
};

const ProfileForm = ({ image, groupsList, formData, handleFormSubmit, handleChange, handleImageChange }) => {
    return (
        <Form onSubmit={handleFormSubmit}>

            <RoundImageForm image={image} onImageChange={handleImageChange} />

            <ItemsList itemList={groupsList} formData={formData} handleChange={handleChange} />
