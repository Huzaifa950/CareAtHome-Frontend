                        ...
                        <div className='SignUp_interface-inner'>
                            <div className='SignUp_text'>
                                <div className='SignUp_Heading'>
                                    <h2>
                                        Greetings to Care at Home
                                    </h2>
                                </div>

                                <div className='SignUp_textBody'>
                                    <p>
                                    Unlock the care services by joining <b><i>Care At Home</i></b>! Don't miss out - register today and open the door to a new realm of services and possibilities!
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='SignUp_form'>
                                <div className='SignUp_form_container'>
                                    ...
                                    <form className='SignUp_formBottom' 
                                        onSubmit={e => {
                                            e.preventDefault();
                                            handleSignUp();
                                        }}>
                                        ...
                                        <div className='SignUp_formBottom-Down'>
                                            ...
                                            <div className='SignUp_button'>
                                                <button className='SignUp_logInButton' type="submit">Register</button>
                                            </div>
