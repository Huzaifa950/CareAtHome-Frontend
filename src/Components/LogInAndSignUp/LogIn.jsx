...
function LogIn({ updateLogInStatus }) {
  ...
  const handleLogIn = async () => {
    ...
    if (
      userDetail.password.length > 100 ||
      userDetail.password.length < 8 ||
      userDetail.usernameOrEmail.length > 100 ||
      userDetail.usernameOrEmail.length > 50
    ) {
            ...
            <div className="LogIn_interface-inner">
              <div className="LogIn_text">
                <div className="LogIn_Heading">
                  <h2>Welcome to Care At Home</h2>
                </div>

                <div className="LogIn_textBody">
                  <p>
                    Unlock a world of personalized care at your fingertips. Log
                    in to the{" "}
                    <i>
                      <b>Care At Home</b>
                    </i>{" "}
                    website and experience a seamless journey tailored to your
                    unique needs.
                  </p>
                </div>
              </div>
                    ...
                    <div className="LogIn_formBottom-Up">
                      <div className="LogIn_email">
                        ...
                        <input
                          ...
                          type="text"
                          id="LogIn_email"
                          value={userDetail.usernameOrEmail}
