      ...
      <Container fluid style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ flex: '1', textAlign: 'center', position: 'relative' }}>
          <Form className="mx-auto my-2 d-inline-flex" style={{ position: 'relative' }}>
            <FormControl type="search" placeholder="What Services are you looking for today ?" className="mr-2" style={{ width: '60%', padding: '15px 40px 15px 20px', borderRadius: '50px', border: 'none', backgroundColor: 'white', outline: 'none ' }} />
          </Form>
        </div>
